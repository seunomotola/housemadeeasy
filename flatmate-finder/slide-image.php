...
<div id="main-wrapper">
    ...
    <div class="page-banner-section section" style="background-image: url(assets/images/bg/single-property-bg.jpg)">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h1 class="page-banner-title"><?php echo ucwords($post['house_name']); ?></h1>
                            ...
                            <?php }
                               ...
                               ?>
                                    <div class="single-property-gallery">
                                        ...
                                        <div class="item"><img src="assets/images/slide/<?php echo $post['house_img2']; ?>" alt=""></div>
                                        <div class="item"><img src="assets/images/slide/<?php echo $post['house_img3']; ?>" alt=""></div>
                                        <div class="item"><img src="assets/images/slide/<?php echo $post['house_img4']; ?>" alt=""></div>
                                    </div>
       ...
       */
        //$datetoday=strtotime($date_paid+20*60);
                                                ...
                                                //$date=date('Y-m-d H:i:s', strtotime('tomorrow'));
                                                 //$datetoday=strtotime($payment_expire);
                                                 //$link_expire=$datetoday+5*24*60*60;
                                                //echo $datetoday.'<br>';
                                               //echo $link_expire;
                                                //echo $date;
                                                 ?>
                                   ...
                                   <!-- <div class="row">
                                    ...
                                    <hr>
                                       <ol >
                                                ...
                                                <li style="font-weight: bolder;">First Year: # <?php echo $post['first_year_rent'];?> </li>
                                                <li style="font-weight: bolder;">Subsquently: # <?php echo $post['second_year_rent'];?> </li>
                                                <!--<li>Subsquently: # <?php 
                                                /*
                                                date_default_timezone_set('Africa/Lagos');
                                                $datetoday = date('Y-m-d h:i:s', time() );
                        ...
                        elseif ($post['multiple_room']=='no'){
                            ...
                            //put an image that we say house not available for now  
                               ?>
                                <a style="pointer-events: none;" class="btn btn-primary btn-flat " style="text-align: center; color: white;"><i class="fa fa-calendar"></i> Click to book an Appointment</a>
                                 <script src="https://js.paystack.co/v1/inline.js"></script>
