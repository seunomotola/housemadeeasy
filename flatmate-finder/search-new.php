           ...
           <div class="row mt-20">
                <div class="col">
                    <ul class="page-pagination">
                       <?php
                         if($page>1){ ?>
                                    <li><a href="search-new.php?page=<?php echo $previous; ?>&price=<?php echo $price ;?>&type=<?php echo $type?>&location=<?php echo $location;?>"><i class="fa fa-angle-left"></i> Prev</a></li>
                               <?php }
                        ...
                        $class_name = "";
                            ...
                            <li class='<?php echo $class_name ?>'><a  href='search-new.php?page=<?php echo $i; ?>&price=<?php echo $price ;?>&type=<?php echo $type?>&location=<?php echo $location;?>' class='btn btn-primary'><?php echo $i ?></a></li>
