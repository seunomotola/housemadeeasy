 ...
 include ('inc/header.inc.php');   ?>
    ...
    <div class="property-section section pt-100 pt-lg-80 pt-md-70 pt-sm-60 pt-xs-50 pb-100 pb-lg-80 pb-md-70 pb-sm-60 pb-xs-50">
        <div class="container">
            ...
            <div class="row">
                 <?php 
                    $sql = "SELECT * FROM properties where status='no' order by id ASC limit 6";
                    $query = $con->query($sql);
                     if ($query->num_rows > 0) {
  ...
  if(isset($_GET["page"])) {
     ...
     $sql ="SELECT  * from properties   order by id desc LIMIT $start_from, $num_per_page ";
            ...
            <div class="row mt-20">
                <div class="col">
                    <ul class="page-pagination">
                       <?php
                         if($page>1){ ?>
                                    <li><a href="search-all-properties.php?page=<?php echo $previous; ?>"><i class="fa fa-angle-left"></i> Prev</a></li>
                               <?php }
                        ...
                        $class_name = "";
                            ...
                            <li class='<?php echo $class_name ?>'><a  href='search-all-properties.php?page=<?php echo $i; ?>' class='btn btn-primary'><?php echo $i ?></a></li>
                       
                  <?php  }
                        if($i>$page) {?>
                                
                                    <li><a href="search-all-properties.php?page=<?php echo $Next; ?>"><i class="fa fa-angle-right"></i> Next</a></li>
                               <?php }
                       ?>
                    </ul>
                </div>
