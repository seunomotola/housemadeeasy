            ...
            <div class="row"> 
                 <?php 
                    $sql = "SELECT * FROM market_place_properties where item_status='no' and item_cat='Appliances'"; 
                    $query = $con->query($sql);
                     if ($query->num_rows > 0) {
               ...
               <?php } }else{
                echo "<div style='text-align:center; font-weight:bolder'>Appliances is not available at the Moment</div>";
               }?>
