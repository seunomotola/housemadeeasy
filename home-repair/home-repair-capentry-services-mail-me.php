<?php
//$source="<img src='assets/images/home-repair-customer-image/'.$photo>"
...
A customer is requesting for the services of a capenter via housemadeeasy.<br><br>
...
Description of Capentry Work: $description<br><br>
