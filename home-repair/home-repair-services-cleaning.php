...
include ('inc/header.inc.php');   ?>
    ...
    <div class="page-banner-section section" style="background-image: url(assets/images/bg/homerepair.jpg);"> 
        <div class="container">
            <div class="row">
                <div class="col">
                    <h1 class="page-banner-title">Cleaning Services</h1>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-12 ml-auto mr-auto">
                    ...
                    <ul class="login-register-tab-list nav"> 
                        <li><a class="active" href="#login-tab" data-toggle="tab">Cleaning Made Easy!</a></li><br><br>
                         <p style=" font-weight: bolder; text-align: center;">With housemadeeasy cleaning services, you don't need to bother about cleaning your house by yourself. Just make your request and we'll get you a cleaner based on your budget!!<br> For any request  made, We'll get back to you within 24hours.</p>
                         
                    </ul>
                    
                    <div class="tab-content">
                        <div id="login-tab" class="tab-pane show active">
                            <form action="home-repair-services-cleaning-process.php" method="POST" enctype="multipart/form-data">
                                ...
                                <select class="form-control" name="kindofapartment" required>
                                    <option value="" required>What type of Apartment do you want to clean ?</option>
