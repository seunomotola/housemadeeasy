...
include ('inc/header.inc.php');   ?>
    ...
    <div class="page-banner-section section" style="background-image: url(assets/images/bg/homerepair.jpg);"> 
        <div class="container">
            <div class="row">
                <div class="col">
                    <h1 class="page-banner-title">Plumbing Services</h1>
                    <ul class="page-breadcrumb">
                        <li><a href="index.php">Home</a></li>
                        <li class="active">Plumbing Services</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-12 ml-auto mr-auto">
                    ...
                    <ul class="login-register-tab-list nav"> 
                        <li><a class="active" href="#login-tab" data-toggle="tab">Plumbing Made Easy!!</a></li><br><br>
                         <p style=" font-weight: bolder; text-align: center;">With housemadeeasy plumbing services, you don't need to bother about doing the plumbing work of your house by yourself. Just make your request and we'll get you a Plumber based on your budget!!<br> For any request  made, We'll get back to you within 24hours.</p>
                         
                    </ul>
                    
                    <div class="tab-content">
                        <div id="login-tab" class="tab-pane show active">
                            <form action="home-repair-services-plumbing-process.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-12 mb-30">
                                        ...
                                        <div class="col-12 mb-30">
                                       <label for="edit_lastname" class="col-12 control-label" style="font-weight:bolder;">Upload a picture of the plumbing work to be done 1</label>
                                        <input type="file" required class="form-control"  name="photo1" >
                                        </div>

                                         <div class="col-12 mb-30">
                                       <label for="edit_lastname" class="col-12 control-label" style="font-weight:bolder;">Upload a picture of the plumbing work to be done 2</label>
                                        <input type="file"  class="form-control"  name="photo2" >
                                        </div>

                                         <div class="col-12 mb-30">
                                       <label for="edit_lastname" class="col-12 control-label" style="font-weight:bolder;">Upload a picture of the plumbing work to be done 3</label>
                                        <input type="file"  class="form-control"  name="photo3" >
                                        </div>

                                         <div class="col-12 mb-30">
                                       <label for="edit_lastname" class="col-12 control-label" style="font-weight:bolder;">Upload a picture of the plumbing work to be done 4</label>
                                        ...
                                        <div class="col-12 mb-30">
                                            <textarea required name="description" class="form-control form-height-custom" placeholder="Describe the Plumbing work you want to do e.g leak pipe etc?"></textarea>
