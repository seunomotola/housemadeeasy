...
$house_img4 = $uploadedImages['house_img4'] ?? '';
   ...
   //  $house_id_short= bin2hex(random_bytes(4));
    ...
    $get_p = "select * from properties where house_id='$house_id'";
     ...
     $first_year_rent = (int)str_replace(',', '', $row_edit['first_year_rent']); 
     $second_year_rent = $row_edit['second_year_rent'];  
...
if (!empty($house_name)) {
    ...
    $messageContent = str_replace(
        ...
        [$id, number_format($first_year_rent), $initial_payment, $embedUrl], // Corresponding values
        $messageTemplate
    );
} else {
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Your house was uploaded successfully. Here is the message content for sharing on WhatsApp:</p>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        shareButton.addEventListener("click", function () {
            ...
            const whatsappURL = `https://wa.me/?text=${message}`; // Create WhatsApp URL
            shareButton.setAttribute("href", whatsappURL); // Set the link
