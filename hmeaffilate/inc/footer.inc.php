            ...
            <div class="container">
                <div class="row row-25">
                    ...
                    <div class="footer-widget col-lg-3 col-md-6 col-12 mb-40">
                        ...
                        <p>Housemadeeasy - An  e-platform housing website that help you as a student to get your desire house easily....</p>
                    ...
                    <div class="footer-widget col-lg-3 col-md-6 col-12 mb-40">
                        ...
                        <ul>
                            ...
                            <li><i class="fa fa-phone"></i><span>+234 7037 092 267<br>+234 8160 852 570</span></li>
                            <li><i class="fa fa-envelope-o"></i><span>support@housemadeeasy.org</span></li>
                        </ul>
                    </div>
                    <!--Footer Widget end-->
                    ...
                    <div class="footer-widget col-lg-3 col-md-6 col-12 mb-40">
                        ...
                        <p>Subscribe our newsletter and get all latest news about our latest News, promotions, offers and discount</p>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright text-center">
                            <p>Copyright &copy;<?php echo date('Y')?> Housemadeeasy. All rights reserved.<br> Designed by <a href="https://codon.ng" style="font-weight:bolder; color: red; font-size: 15px">codon</a></p>
                        </div>
                    </div>
                </div>
            </div>
