  ...
  if(isset($_POST['resetpassword'])){
    ...
    $query = mysqli_query($con,"SELECT * FROM hmeaffilate_user WHERE email = '$email'"); 
...
$headers = "FROM: $from\r\n";
 ...
 if(mail($to, $subject, $body, $headers)){
  $sql= "UPDATE user SET token='$str' WHERE email='$email'";
         ...
         //echo $body;
exit('<div style="color:green; text-align:center; font-size:15px;">Pls Check your email to reset your Password.... </div>');
 }else{
