                    ...
                    <table class="table table-striped table-bordered table-hover"><!-- table table-striped table-bordered table-hover begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                $get_orders = "select * from bookings";
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td> 
                                     ...
                                     <a  class="btn btn-info btn-xs" data-toggle="modal" data-target="#view-modal" data-id="<?php echo $id ?>" id="getUser">View</a>
                                </td>
                            </tr><!-- tr finish -->
