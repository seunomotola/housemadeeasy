...
<body>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <ul class="page-breadcrumb">
                        ...
                        <li class="active">You desire to check the house today</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container" style="padding:380px 0px 20px 0px;">
        ...
        <?php if (empty($cart_items)): ?>
            ...
            <a href="search-made-easy.php" class="btn btn-primary" style="border-radius:50px; text-transform: lowercase; text-align:center;">Start Searching for House</a>
        <?php else: ?>
            <table class="table table-bordered">
                    ...
                    <?php foreach ($cart_items as $item): ?>
                     ...
                     // $amount2=$_SESSION['amount'];
                        ...
                        <tr> 
                            ...
                            <td data-label="Checking Fees">#<?php echo number_format($price); ?></td>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th colspan="4">#<?php echo number_format($total_price); ?></th>
                        <?php 
    ...
    <?php if (!empty($cart_items)){
                            ...
                            if (isset($_SESSION['multiple_room']) && $_SESSION['multiple_room'] == 'yes') { 
                              ...
                              <?php if(isset($_SESSION['user_id']) ) { ?>
                                   <a  class="btn btn-primary btn-flat click " id="checkout-button" style=" border-radius:50px;  margin-top: 50px; padding:20px; text-align: center; color: white; text-transform: lowercase;" onclick="urgentalreadyloginIn()" ><i class="fa fa-calendar"></i> Click to check the house today</a>
                                 <script src="https://js.paystack.co/v1/inline.js"></script>
                               ...
                               <?php  }else{ ?>
                                    ...
                                    <a  class="btn btn-primary btn-flat" id="checkout-button2" style="border-radius:50px;  margin-top: 50px; padding:20px; text-align: center; color: white; text-transform: lowercase;" onclick="urgentnotalreadyloginIn()" ><i class="fa fa-calendar"></i> Click to check the house today</a>
                                    <!-- urgent booking end-->
        ...
        elseif (isset($_SESSION['multiple_room']) && $_SESSION['multiple_room'] == 'no') {
                                 ...
                                 if(isset($_SESSION['user_id']) ) { ?>
                                      <a  class="btn btn-primary btn-flat click " id="checkout-button" style="border-radius:50px; padding:20px; text-align: center; color: white; text-transform: lowercase; margin-top: 50px;" onclick="urgentalreadyloginIn()" ><i class="fa fa-calendar"></i> click to check the house today</a>
...
<!-- <script type="text/javascript">
    function urgentnotalreadyloginIn() {
        swal({
            ...
            if (proceed) {
                $.ajax({
                    url: 'check_user_registration.php',
                    method: 'POST',
                    dataType: 'json',
                    success: function(response) {
    ...
    <script type="text/javascript">
        ...
        function urgentalreadyloginIn() {
            swal({
                ...
                text: "You have clicked to make an urgent appointment with the agent of this house.You would be paying an unredeemable sum of <?php echo $amountInWords; ?>(#<?php echo number_format($total_price); ?>) after clicking the I Agree icon. After Paying, you would be giving that day you book to come and check the house. Note that you must make yourself available this time that you have picked otherwise, you may have to pay another (#<?php echo number_format($total_price); ?>) to book another appointment. After picking the time, call the agent, introduce yourself and inform him that you will be coming by the time you choose to check the house.",
