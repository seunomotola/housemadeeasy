...
$query = mysqli_query($con, "SELECT * FROM bookings_urgent WHERE user_id='$user_id' AND house_id='$key'"); 
...
$all_bookings_query = mysqli_query($con, "SELECT * FROM bookings_urgent WHERE user_id='$user_id' AND date='$date' AND timeslot='$timeslot'");
...
$pdf->output($fname . $house_name . ' checking fees receipt.pdf', 'I'); 
?>
