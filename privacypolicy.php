<?php
$page_title = "Privacy Policy - HouseMadeEasy";
            ...
            <div class="card shadow">
                <div class="card-body p-5">
                    ...
                    <div class="content">
                        ...
                        <p>Welcome to HouseMadeEasy ("we," "our," or "us"). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.</p>
                        ...
                        <p>Our services are not intended for children under the age of 13. We do not knowingly collect personal information from children under 13. If we become aware that we have collected such information, we will take steps to delete it promptly.</p>
                        ...
                        <ul>
                            <li>Email: privacy@housemadeeasy.com.ng</li>
                            <li>Phone: +234 XXX XXX XXXX</li>
                            <li>Address: [Your Business Address]</li>
                        </ul>

                        <div class="alert alert-info mt-4">
                            <strong>Note:</strong> This Privacy Policy is designed to comply with applicable data protection laws, including the Nigerian Data Protection Regulation (NDPR) and other relevant privacy laws.
                        </div>
                    </div>
                </div>
            </div>
